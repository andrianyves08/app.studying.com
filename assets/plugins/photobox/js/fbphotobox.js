	...
	FBPhotoBox.prototype = {
		...
		initDOM: function() {
			var html = ['<div class="fbphotobox-main-container">',
							'<div class="d-flex"><span class="fbphotobox-container-left">',
								'<table class="fbphotobox-main-image-table"><tr><td>',
									'<div class="tag-container"><img class="fbphotobox-main-image img-fluid " src=""/></div>',
								'</td></tr></table>',
								...
								'</div>',
							'</span>',
							'<span class="fbphotobox-container-right">',
								'<div class="fbphotobox-image-content p-2">',
