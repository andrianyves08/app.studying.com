    ...
    <div class="col-md-4">
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <div>
          <button type="button" class="btn btn-primary btn-sm m-0 px-2 py-2" data-toggle="modal" data-target="#changemodule">Add Purchases</button>
          <button type="button" class="btn btn-info btn-sm m-0 px-2 py-2" data-toggle="modal" data-target="#changestatus">Change Status</button>
          <button type="button" class="btn btn-success btn-sm m-0 px-2 py-2" data-toggle="modal" data-target="#change_password">Change Password</button>
          <button type="button" class="btn btn-secondary btn-sm m-0 px-2 py-2" data-toggle="modal" data-target="#changeprofile">Change Profile</button>
        </div>
        </div>
